...
def predict(image):
    ...
    if predictions[0][0] == 1.0:
        ...
        return "Precancerous", """These are conditions or changes in the body that may lead to cancer if left untreated.
         Examples include abnormal cell growth or tissue changes, such as in the case of 
         cervical dysplasia or colon polyps. Precancerous conditions require medical attention and monitoring to 
